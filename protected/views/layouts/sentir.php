<html lang="en"><!-- Mirrored from diliat.in/themeforest/sentir/1.2/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Sep 2014 14:38:33 GMT --><head>
    <meta charset="utf-8">
    ...
    <link href="<?=$this->getThemePath()?>/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="<?=$this->getThemePath()?>/assets/plugins/fullcalendar/fullcalendar/fullcalendar.print.css" rel="stylesheet" media="print">
...
<div class="logo-brand">
    <a href="index-2.html"><img src="<?=$this->getThemePath()?>/assets/img/sentir-logo-primary.png" alt="Sentir logo"></a>
</div><!-- /.logo-brand -->
<!-- End Logo brand -->
...
<ul class="nav-user navbar-right">
    <li class="dropdown">
        <a href="#fakelink" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-1.jpg" class="avatar img-circle" alt="Avatar">
            Hi, <strong><?php echo Yii::app()->user->user_login ?></strong>
        </a>
...
<div class="navbar-collapse collapse" id="main-fixed-nav" style="height: 1px;">
            ...
            <div class="nav-dropdown-content">
                <ul>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-2.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Thomas White</strong> posted on your profile page
                            <span class="small-caps">17 seconds ago</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-3.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Doina Slaivici</strong> uploaded photo
                            <span class="small-caps">10 minutes ago</span>
                        </a></li>
                    <li><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-4.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Harry Nichols</strong> commented on your post
                            <span class="small-caps">40 minutes ago</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-5.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Mihaela Cihac</strong> send you a message
                            <span class="small-caps">2 hours ago</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-6.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Harold Chavez</strong> change his avatar
                            <span class="small-caps">Yesterday</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-7.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Elizabeth Owens</strong> posted on your profile page
                            <span class="small-caps">Yesterday</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-8.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Frank Oliver</strong> commented on your post
                            <span class="small-caps">A week ago</span>
                        </a></li>
                    <li><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-9.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            <strong>Mya Weastell</strong> send you a message
                            <span class="small-caps">April 15, 2014</span>
                        </a></li>
                    <li><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-10.jpg" class="absolute-left-content img-circle" alt="Avatar">
    ...
    <ul class="dropdown-menu square margin-list-rounded with-triangle">
        <li>
            ...
            <div class="nav-dropdown-content">
                <ul>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-25.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            Lorem ipsum dolor sit amet, consectetuer adipiscing elit
                            <span class="small-caps">17 seconds ago</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-24.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat
                            <span class="small-caps">10 minutes ago</span>
                        </a></li>
                    <li><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-23.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            I think so
                            <span class="small-caps">40 minutes ago</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-22.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            Yes, I'll be waiting
                            <span class="small-caps">2 hours ago</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-21.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            Thank you!
                            <span class="small-caps">Yesterday</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-20.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            No problem! I will never remember that
                            <span class="small-caps">Yesterday</span>
                        </a></li>
                    <li class="unread"><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-19.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            Tak gepuk ndasmu sisan lho dab!
                            <span class="small-caps">A week ago</span>
                        </a></li>
                    <li><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-18.jpg" class="absolute-left-content img-circle" alt="Avatar">
                            Sorry bro, aku or atau sing jenenge ngono kui
                            <span class="small-caps">April 15, 2014</span>
                        </a></li>
                    <li><a href="#fakelink">
                            <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-17.jpg" class="absolute-left-content img-circle" alt="Avatar">
    ...
    <ul class="dropdown-menu square margin-list-rounded with-triangle">
        <li>
            ...
            <div class="nav-dropdown-content static-list">
                <ul>
                    <li>
                        <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-12.jpg" class="absolute-left-content img-circle" alt="Avatar">
                        <div class="row">
                            <div class="col-xs-6">
                    ...
                    <li>
                        <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-13.jpg" class="absolute-left-content img-circle" alt="Avatar">
                        <div class="row">
                            <div class="col-xs-6">
                    ...
                    <li>
                        <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-14.jpg" class="absolute-left-content img-circle" alt="Avatar">
                        <div class="row">
                            <div class="col-xs-6">
                    ...
                    <li>
                        <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-15.jpg" class="absolute-left-content img-circle" alt="Avatar">
                        <div class="row">
                            <div class="col-xs-6">
                    ...
                    <li>
                        <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-16.jpg" class="absolute-left-content img-circle" alt="Avatar">
                        <div class="row">
                            <div class="col-xs-6">
...
<li>
    <a href="<?= $this->createUrl("racks/index") ?>">
...
<div class="sidebar-right-heading">
    <ul class="nav nav-tabs square nav-justified">
        <li class=""><a href="#online-user-sidebar" data-toggle="tab"><i class="fa fa-comments"></i></a></li>
        ...
        <li class=""><a href="#setting-sidebar" data-toggle="tab"><i class="fa fa-cogs"></i></a></li>
    </ul>
...
<!-- BEGIN SIDEBAR RIGHT -->
<div class="sidebar-right sidebar-nicescroller" tabindex="5000" style="overflow: hidden; outline: none;">
<div class="tab-content">
<div class="tab-pane fade" id="online-user-sidebar">
    <ul class="sidebar-menu online-user">
        <li class="static">ONLINE USERS</li>
        <li><a href="#fakelink">
                <span class="user-status success"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-2.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink">
                <span class="user-status success"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-3.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Doina Slaivici
                <span class="small-caps">Duis autem vel eum iriure dolor in hendrerit in </span>
            </a></li>
        <li><a href="#fakelink">
                <span class="user-status success"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-4.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink">
                <span class="user-status success"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-5.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <i class="fa fa-mobile-phone device-status"></i>
                Mihaela Cihac
        ...
        <li><a href="#fakelink">
                <span class="user-status success"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-6.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink">
                ...
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-7.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink">
                <span class="user-status warning"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-8.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <i class="fa fa-apple device-status"></i>
                Frank Oliver
        ...
        <li><a href="#fakelink">
                <span class="user-status warning"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-9.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Mya Weastell
                <span class="small-caps">15 minutes</span>
            </a></li>
        <li><a href="#fakelink">
                <span class="user-status warning"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-10.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <i class="fa fa-mobile-phone device-status"></i>
                Carl Rodriguez
        ...
        <li><a href="#fakelink">
                <span class="user-status warning"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-11.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <i class="fa fa-mobile-phone device-status"></i>
                Nikita Carter
        ...
        <li><a href="#fakelink">
                ...
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-12.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Craig Dixon
                <span class="small-caps">Last seen 2 hours ago</span>
            </a></li>
        <li><a href="#fakelink">
                <span class="user-status danger"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-13.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Mikayla King
                <span class="small-caps">Last seen yesterday</span>
            </a></li>
        <li><a href="#fakelink">
                <span class="user-status danger"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-14.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Richard Dixon
                <span class="small-caps">Last seen Feb 20, 2014 05:45:50</span>
            </a></li>
        <li><a href="#fakelink">
                <span class="user-status danger"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-15.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Brenda Fuller
                <span class="small-caps">Last seen Feb 15, 2014 11:35:50</span>
            </a></li>
        <li><a href="#fakelink">
                <span class="user-status danger"></span>
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-16.jpg" class="ava-sidebar img-circle" alt="Avatar">
                Ryan Ortega
                <span class="small-caps">Last seen Jan 20, 2014 03:45:50</span>
            </a></li>
    </ul>
</div>
<div class="tab-pane fade active in" id="notification-sidebar">
    <ul class="sidebar-menu sidebar-notification">
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Karen Wallace" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-25.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Phillip Lucas" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-24.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <span class="activity">Uploaded a photo</span>
                <span class="small-caps">2 hours ago</span>
            </a></li>
        <li><a href="#fakelink" data-toggle="tooltip" title="Sandra Myers" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-23.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Charles Guerrero" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-22.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Maria Simpson" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-21.jpg" class="ava-sidebar img-circle" alt="Avatar">
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Jason Crawford" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-20.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <span class="activity">Posted something on your profile page</span>
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Cynthia Mendez" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-19.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <span class="activity">Uploaded a photo</span>
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Peter Ramirez" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-18.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <span class="activity">Commented on your post</span>
        ...
        <li><a href="#fakelink" data-toggle="tooltip" title="Jessica Gutierrez" data-placement="left">
                <img src="<?=$this->getThemePath()?>/assets/img/avatar/avatar-17.jpg" class="ava-sidebar img-circle" alt="Avatar">
                <span class="activity">Send you a message</span>
...
<!-- BEGIN FOOTER -->
<footer>
    © 2014 <a href="#fakelink">Your company</a><br>
...
<script src="<?=$this->getThemePath()?>/assets/plugins/newsticker/jquery.newsTicker.min.js"></script>
...
<script src="<?=$this->getThemePath()?>/assets/plugins/flot-chart/example.js"></script><div id="flotTip" style="display: none; position: absolute;"></div>
...
<script src="<?=$this->getThemePath()?>/assets/js/demo-panel.js"></script>



<!-- Mirrored from diliat.in/themeforest/sentir/1.2/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Sep 2014 14:40:53 GMT -->
<div id="ascrail2000" class="nicescroll-rails" style="width: 0px; z-index: 1; cursor: default; position: fixed; top: 60px; height: 263px; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 0px; height: 283px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(18, 18, 18); background-clip: padding-box;"></div></div><div id="ascrail2000-hr" class="nicescroll-rails" style="height: 0px; z-index: 1; top: 323px; position: fixed; cursor: default; display: none; width: 250px; opacity: 0;"><div style="position: relative; top: 0px; height: 0px; width: 250px; border: 0px solid rgb(255, 255, 255); border-radius: 0px; background-color: rgb(18, 18, 18); background-clip: padding-box;"></div></div></body></html>